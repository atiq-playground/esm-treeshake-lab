...
- **Map**: a single issue labelled `windwaker:map`, holding the Notes / Decisions-so-far / Fog body. Current map: [#1 ESM tree-shake lab monorepo](https://github.com/atiq-playground/esm-treeshake-lab/issues/1).
...
Local markdown under `.scratch/esm-treeshake-lab/` is a non-canonical mirror from charting; prefer GitHub.
